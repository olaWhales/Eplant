...
import com.whales.eplant.dto.request.dj.DjRequest;
...
//
//            Map<String, Object> roleAttributes = request.getRoleAttributes();
//            DjRequest djRequest = (DjRequest) request.getRoleAttributes();
//            List<String>musicGenres = Utility.safeCastStringList(roleAttributes.get("musicGenres"));
//
//            Dj dj = Dj.builder()
//                    .lightingIncluded(djRequest.isLightingIncluded())
//                    .numberOfSpeakers(djRequest.getNumberOfSpeakers())
//                    .performanceDuration(djRequest.getPerformanceDuration())
//                    .numberOfMicrophones(djRequest.getNumberOfMicrophones())
