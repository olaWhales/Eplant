...
//                new UsernamePasswordAuthenticationToken("ajaditaoreed100@gmail.com", null, null)
//        );
//
...
//        verify(userRepository).findByEmailWithVendors("ajaditaoreed100@gmail.com");
...
//        // Arrange
//        when(userRepository.findByEmailWithVendors("ajaditaoreed100@gmail.com")).thenReturn(Optional.empty());
//
//        // Act & Assert
//        UsernameNotFoundException exception = assertThrows(UsernameNotFoundException.class, () -> {
//            vendorRegistrationMethod.vendorRegistration(vendorRequest);
//        });
//        assertEquals("User not found: ajaditaoreed100@gmail.com", exception.getMessage());
//        verify(userRepository).findByEmailWithVendors("ajaditaoreed100@gmail.com");
